...
public class Main2Fragment extends Fragment implements View.OnClickListener{
    ...
    private Button btn_dialog_1 ,btn_dialog_2, btn_dialog_3,btn_dialog_4,btn_dialog_5,btn_dialog_6,btn_dialog_7, btn_dialog_8, btn_dialog_9, btn_dialog_10, btn_dialog_11;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        NestedScrollView nestedScrollView= (NestedScrollView) inflater.inflate(R.layout.fragment_main2,container,false);
        ...
        switch (v.getId()){
            ...
            case R.id.btn_dialog_2:
                new AlertDialog.Builder(getContext())
                        ...
                        .setMessage("A material meta")
                        .setPositiveButton("OK",null)
                        .setNegativeButton("Cancel",null)
                        .show();
                break;
            case R.id.btn_dialog_3:
                String [] single=getResources().getStringArray(R.array.dialog_choice_array);
                int item=0;
                new AlertDialog.Builder(getContext())
                        .setTitle("single choice")
                        .setSingleChoiceItems(single, item, new DialogInterface.OnClickListener() {
                            @Override
            ...
            case R.id.btn_dialog_4:
                String[] get=getResources().getStringArray(R.array.dialog_choice_array);
                boolean[] check={true,false,false,false,false};
                new AlertDialog.Builder(getContext())
                        .setTitle("mulit choice")
                        .setMultiChoiceItems(get,check,null)
                        .setPositiveButton("OK",null)
                        .setNegativeButton("Cancel",null)
                        .show();
                break;
            ...
            case R.id.btn_dialog_6:
                final ProgressDialog horizProgress=new ProgressDialog(getContext());
                horizProgress.setProgressStyle(ProgressDialog.STYLE_HORIZONTAL);
                horizProgress.setMessage("progress dialog");
                horizProgress.setCancelable(false);
                horizProgress.setMax(100);
                horizProgress.show();
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        while (progress<=100){
                            horizProgress.setProgress(progress);
                            if (progress==100){
                                horizProgress.dismiss();
                            }
                            try {
                                Thread.sleep(10);
            ...
            case R.id.btn_dialog_8:
                ...
                TimePickerDialog timePickerDialog=new TimePickerDialog(getContext(), new TimePickerDialog.OnTimeSetListener() {
                    ...
                    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                        ...
                        btn_dialog_8.setText(hourOfDay+":"+minute);
                    }
            ...
            case R.id.btn_dialog_9:
                ...
                View dialogView = getActivity().getLayoutInflater().inflate(R.layout.bottom_layout, null);
                ...
                Glide.with(getContext()).load(R.drawable.budeniao).into(img_bottom_dialog);
            ...
            case R.id.btn_dialog_10:
                ...
                fullscreenDialog.setContentView(R.layout.bottom_layout);
                ImageView img_full_screen_dialog = (ImageView) fullscreenDialog.findViewById(R.id.img_bottom_dialog);
                Glide.with(getContext()).load(R.drawable.budeniao).into(img_full_screen_dialog);
                ImageView img_dialog_fullscreen_close = (ImageView) fullscreenDialog.findViewById(R.id.img_bottom_dialog);
