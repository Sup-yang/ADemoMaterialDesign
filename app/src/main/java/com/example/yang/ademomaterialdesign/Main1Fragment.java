...
public class Main1Fragment extends Fragment implements View.OnClickListener,View.OnTouchListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        NestedScrollView nestedScrollView= (NestedScrollView) inflater.inflate(R.layout.fragment_main1,container,false);
        btn_card_main1_action1= (Button) nestedScrollView.findViewById(R.id.btn_card_main_action1);
        btn_card_main1_action2= (Button) nestedScrollView.findViewById(R.id.btn_card_main_action2);
        ...
        img_main_card_1= (ImageView) nestedScrollView.findViewById(R.id.img_main_card1);
        ...
        card_main_1_1 = (CardView) nestedScrollView.findViewById(R.id.card_main1);
        card_main_1_2 = (CardView) nestedScrollView.findViewById(R.id.card_main2);
        card_main_1_3 = (CardView) nestedScrollView.findViewById(R.id.card_main3);
        card_main_1_4_1 = (CardView) nestedScrollView.findViewById(R.id.card_main4_1);
        card_main_1_4_2 = (CardView) nestedScrollView.findViewById(R.id.card_main4_2);
...
//                break;
            ...
            case R.id.card_main1:
                break;

            case R.id.card_main2:
                break;

            case R.id.card_main3:
                break;

            case R.id.card_main4_1:
                break;

            case R.id.card_main4_2:
                break;
